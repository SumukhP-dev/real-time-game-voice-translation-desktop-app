...
todos:
  - id: prep-materials
    ...
    status: pending
  - id: apply-phase2
    content: Submit to YC, ElevateAI, Supercell AI Lab, PLAI (March 2026)
    status: pending
  - id: apply-credits
    content: Apply to Speechmatics, Murf, and Layercode startup programs
    status: pending
  - id: track-phase4
    content: Track and apply to Techstars and F/ai when 2026 applications open
    status: pending
  - id: optional-regional
    content: Evaluate AI Ventures, TechXpedite, Rainmaking APAC if relevant
    status: pending
isProject: false
---
...
flowchart LR
  subgraph prep [Phase 1]
    A[One-pager and deck]
    B[Reusable copy]
    C[Entity and bios]
  end

  subgraph march [Phase 2 - March]
    D[YC]
    E[ElevateAI]
    F[Supercell AI Lab]
    G[PLAI 2026]
